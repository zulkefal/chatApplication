  ...
  return (
    <div className='border-r border-slate-500 p-2 flex flex-col' >
      <form className='flex flex-row items-center m-1 gap-2' action="">
        <input className="input input-bordered rounded-md text-white border-white" placeholder='search' type="text"  />
    ...
    <OtherUsers/>
    <div className='mt-2 '>
        <button className='bg-gray-500 rounded-lg btn-sm text-white hover:bg-red-400 flex-1' onClick={logoutNow} >Logout</button>
    </div>
